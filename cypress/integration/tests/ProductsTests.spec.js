...
describe("Products Tests", () => {
  ...
  it("should add Bolt T-Shirt to cart and check the price", () => {
    ...
    cy.contains("Sauce Labs Bolt T-Shirt")
      .should("be.visible")
      .and("have.length", 1);
    cy.get(".inventory_item_price").should("have.text", "$15.99"); //item price methods should be added
  });
  ...
  it("should add Onesie to cart and check the price", () => {
    ...
    inventoryPage.goToCart();
    cy.contains("Sauce Labs Onesie").should("be.visible").and("have.length", 1);
